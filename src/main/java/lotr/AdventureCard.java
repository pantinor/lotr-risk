...
public enum AdventureCard {
    ...
    //
    GRIMA_WORMTONGUE_1(MISSION, "PLAY BEFORE INVADING A TERRITORY.", "Remove up to 2 enemy battalions from the Territory you are invading and add them to your invading Territory. 1 defending battalion must always remain."),
    GRIMA_WORMTONGUE_2(MISSION, "PLAY BEFORE INVADING A TERRITORY.", "Remove up to 2 enemy battalions from the Territory you are invading and add them to your invading Territory. 1 defending battalion must always remain."),
    ...
    FARAMIR_FINDS_THE_RINGBEARER(MISSION, "PLAY AFTER THE FELLOWSHIP ROLLS THE DIE TO LEAVE A TERRITORY.", "Choose to either add or subtract 2 from the die roll."),
